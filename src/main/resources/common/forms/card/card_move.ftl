...
<div id="cards-center">
    ...
    <div class="generic-container">
        <button hx-post="/forms/packs/${pack_id}/cards/move" hx-vals="js:{dest_id: ${dest_id}, cards: selected_cards}" hx-target="#cards-center" hx-swap="outerHTML">Move cards</button>
    </div>
</div>